...
#     case 
#      when @age 0..5
#        puts "#{@name}さんの入場料は#{@entry_fee[:infant]}円です。"
#      when @age 6..12 
#        puts "#{@name}さんの入場料は#{@entry_fee[:children]}円です。"
#      when @age 13..64 
#        puts "#{@name}さんの入場料は#{@entry_fee[:adult]}円です。"
#      when @age >= 65 
#        puts "#{@name}さんの入場料は#{@entry_fee[:senior]}円です。"
#     end
#   end
end
